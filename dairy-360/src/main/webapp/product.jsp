...
<html>
<head>
    <title>Product Info | Dairy-360</title>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/addProduct">Add Product</a></li>
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="text-warning">Product Information</h3>
        <div>
            <input list="productList" id="productSearch" class="form-control me-2" placeholder="Search products...">
            ...
            <table class="table table-hover align-middle text-center">
                ...
                <c:forEach var="p" items="${products}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/editProduct/${p.productId}"
                               class="btn btn-sm btn-primary">Edit</a>
                            <a href="${pageContext.request.contextPath}/deleteProduct/${p.productId}"
    ...
    <div>
        <c:if test="${currentPage > 1}">
            <a class="btn btn-outline-secondary me-2"
               href="${pageContext.request.contextPath}/product?page=${currentPage - 1}&size=${pageSize}">Previous</a>
        </c:if>
        ...
        <c:if test="${currentPage < totalPages}">
            <a class="btn btn-outline-secondary ms-2"
               href="${pageContext.request.contextPath}/product?page=${currentPage + 1}&size=${pageSize}">Next</a>
        </c:if>
    </div>
    <div>
        <small class="text-white">Page ${currentPage} of ${totalPages} — Total ${total} products</small>
    </div>
</div>
...
<script>
    ...
    searchInput.addEventListener('input', function() {
        ...
        tableRows.forEach(row => {
            ...
            // Show row if query matches product name OR type
            if(productName.includes(query) || type.includes(query)) {
                row.style.display = '';
            } else {
